...
mytextclock = wibox.widget.textclock('<span color="#FF0000">%a,</span>  <span color="#FF6A00">%b</span> <span color="#FFD400">%d</span> <span color="#65FF00">%H</span><span color="#00FAFF">:</span><span color="#006EFF">%M</span><span color="#8C00FF">:</span><span color="#FF007F">%S</span>', 1)
